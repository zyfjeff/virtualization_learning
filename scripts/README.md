...
| `build-rootfs-iperf.sh` | 网络性能专用（phase6） | 1-2 分钟 | busybox-static, iperf3 |
| `boot-vm.sh` | 启动实验 VM | - | qemu-system-x86 |
| `setup-vfio-vm.sh` | 带 VFIO 设备直通的 VM（phase5/phase7） | - | qemu, vfio-pci |
...
- [Phase 6 virtio 实验](../phase6-virtio/README.md)
