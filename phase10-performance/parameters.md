...
`../phase9-capstone/practice/README.md` 的 halt-polling 实验能做成"一轮脚本扫四档"，
正是因为它用的四个参数全是 `0644`。
...
本仓已实测的曲线见 `../phase9-capstone/practice/README.md` 项目 4 M3（poll 开关 ×
...
而 `../phase8-timer-virt/annotations.md:581` 早就明确写过
...
`../phase5-interrupts/posted-interrupts.md`，本文只管参数。
