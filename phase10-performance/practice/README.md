...
| [timer-bench.md](timer-bench.md) | 部分失效 | E4 | 实验 6 那两行 `cat /sys/module/kvm/parameters/lapic_timer_advance_ns` 在 6.12.93 上不存在（D1 —— 那是宿主 6.8.0-51 的布局）。guest 侧的 clocksource / cyclictest 手段仍有效，但机制与结论一律看 `../../phase8-timer-virt/` |
