...
> 理论背景见 `../../phase8-timer-virt/README.md`（clocksource vs
...
> **guest 侧手工手段**；机制与已实测的结论一律看 `../../phase8-timer-virt/`，
> 本文不重复。
...
概念区分见 `../../phase8-timer-virt/README.md`）。
...
（对照 `../../phase8-timer-virt/README.md` 的概念区分）。
...
（背景见 `../../phase8-timer-virt/README.md` 的 timer 章节）：
...
5. 遇到时间跳变/降级时的排查记录（清单见
   `../../phase11-debugging/README.md` 场景 6）
