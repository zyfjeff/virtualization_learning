...
如果你还没有完成 Phase 8，建议先学习 `../phase9-capstone/README.md`。
...
| 职责 | 载体 | 为什么归这里 |
|---|---|---|
| **① 测量的可信性规范** | [`measurement.md`](measurement.md) | 全仓唯一一份"这个性能结论能不能信"的判据：对照组、样本量、噪声控制、观测手段的分辨率与**自身扰动**、归因纪律、报告规范。工具用法与排查树在 `../phase11-debugging/`，两章的分工见 `measurement.md` §0 |
