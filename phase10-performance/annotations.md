...
命令语法与排查顺序见 `../phase11-debugging/annotations.md`；本章只给
"哪个观测点对应哪条判据"。
...
| APICv | `../phase5-interrupts/` | 机制在 phase4 讲得更深 |
| Posted Interrupts | `../phase5-interrupts/posted-interrupts.md` | 零退出结论有规范支撑（SDM 30.6）|
| EPT 遍历 | `../phase2-mem-virt/` | 机制章 |
| kvmclock vs TSC-deadline | `../phase8-timer-virt/README.md` | 时钟章 |
| 性能调试命令集 | `../phase11-debugging/` | 命令归调试章 |
