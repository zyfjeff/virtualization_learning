...
如果你还没有完成 Phase 9，建议先学习 `../phase10-performance/README.md`。
...
# 大页/脏页测量：phase10-performance/practice/bench-huge-dirty.md（E2）
```
...
phase9 性能测量      → 测量纪律与观测成本看 phase10-performance/measurement.md
                       本章提供场景诊断的工具和方法

跨 phase 指针（不复制内容）：
- 模块参数默认值      → phase10-performance/parameters.md
...
- APICv/PI 机制      → phase5-interrupts/posted-interrupts.md
- 时钟虚拟化机制     → phase8-timer-virt/
```
