...
```c
/* 来源: phase9-capstone/practice/mini-kvm/vcpu.c:74-137（注释与错误分支略） */
preempt_disable();
...
```c
/* 来源: phase9-capstone/practice/mini-kvm/vcpu.c:143-162（注入窗口的注释略） */
...
```c
/* 来源: phase9-capstone/practice/mini-kvm/vcpu.c:193-197（末行是摘要，源注释在 :198-205） */
