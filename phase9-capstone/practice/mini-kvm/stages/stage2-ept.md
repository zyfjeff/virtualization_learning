...
```c
/* 来源: phase9-capstone/practice/mini-kvm/ept.c:137-159（注释略） */
...
```c
/* 来源: phase9-capstone/practice/mini-kvm/ept.c:192-227（注释略） */
...
```c
/* 来源: phase9-capstone/practice/mini-kvm/ept.c:233-261（错误分支略） */
