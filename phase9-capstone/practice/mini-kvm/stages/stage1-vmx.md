...
```c
/* 来源: phase9-capstone/practice/mini-kvm/main.c:264-300（on_each_cpu 回调，日志略） */
...
```c
/* 来源: phase9-capstone/practice/mini-kvm/main.c:130-157 */
...
```c
/* 来源: phase9-capstone/practice/mini-kvm/vmx.c:271-325（错误处理略） */
...
```c
/* 来源: phase9-capstone/practice/mini-kvm/vmx.c:561-644（部分字段与注释略） */
