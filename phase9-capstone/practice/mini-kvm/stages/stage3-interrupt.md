...
```c
/* 来源: phase9-capstone/practice/mini-kvm/interrupt.c:55-71 */
...
```c
/* 来源: phase9-capstone/practice/mini-kvm/vcpu.c:152-162 */
...
```asm
/* 来源: phase9-capstone/practice/mini-kvm/guest/guest.S:41-79（注释略） */
	lgdt	gdt_ptr(%rip)
...
```c
/* 来源: phase9-capstone/practice/mini-kvm/interrupt.c:151-165 */
...
```c
/* 来源: phase9-capstone/practice/mini-kvm/interrupt.c:122-143（注释略） */
