# phase9-capstone 勘误（corrections.md）
...
- `../phase8-timer-virt/practice/README.md`：其"前置条件 ②/③"沿用了 A1/A2
  的错误表述（"mask 保持 0"、"静默返回"、`cpuid.c:398-403`、
  `x86.c:675-676`），已在 `../phase8-timer-virt/corrections.md` 单独记录并修正。
...
```bash
cd phase9-capstone/practice/mini-kvm && make            # 模块 + guest + 测试程序
...
第 3 条同类的错在 `phase8-timer-virt/` 还有五处（`practice/README.md` 第 173、285 行、
...
**范围**：改动全在 `phase8-timer-virt/` 的三个文件（`practice/README.md` +3 行、
...
```bash
cd phase9-capstone/practice/mini-kvm
# phase7 三篇（README 56 / corrections 152 / experiment3-lapic.c 27）
./check-refs.py --quiet --fn-strict --kernel ../../../phase8-timer-virt/practice/README.md \
    ../../../phase8-timer-virt/corrections.md ../../../phase8-timer-virt/practice/experiment3-lapic.c
